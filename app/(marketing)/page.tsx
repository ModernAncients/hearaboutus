...
export default function MarketingHome() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F5F7FA' }}>
      {/* Header */}
      <header className="sticky top-0 z-20 flex items-center justify-between border-b border-slate-200 bg-white px-4 py-3" style={{ boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
        <h1 className="text-lg font-semibold text-slate-900">Hear About Us</h1>
        <Link href="/signin">
      ...
      <section className="px-4 py-12 bg-white">
        <div className="max-w-2xl mx-auto">
          <h2 className="text-xl md:text-2xl font-semibold text-slate-900 mb-6">How it works</h2>
      ...
      {/* Product Preview */}
      <section className="px-4 py-12" style={{ backgroundColor: '#F5F7FA' }}>
        <div className="max-w-2xl mx-auto">
          <h2 className="text-xl md:text-2xl font-semibold text-slate-900 mb-6">What you'll see</h2>
        ...
        <div className="max-w-2xl mx-auto">
          <div className="grid grid-cols-3 gap-3 mb-6">
            <Card padding="sm" className="text-center">
              <p className="text-xs font-medium text-slate-500 mb-1">Solo founders</p>
              <p className="text-xl font-bold text-slate-900">Free</p>
            </Card>
            <Card padding="sm" className="text-center">
              <p className="text-xs font-medium text-slate-500 mb-1">Growing teams</p>
              <p className="text-xl font-bold text-slate-900">Fair</p>
            </Card>
            <Card padding="sm" className="text-center">
              <p className="text-xs font-medium text-slate-500 mb-1">Agencies</p>
              <p className="text-xl font-bold text-slate-900">Simple</p>
            </Card>
          </div>
          <Link href="/pricing">
